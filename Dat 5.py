...
# Step 5: Correlation Between Weather Conditions and Temperature Variability
# Group by Weather Condition and calculate temperature standard deviation
variability = df.groupby("Weather Condition")["Temperature (°C)"].std().sort_values(ascending=False)

# Plot temperature variability by weather condition
plt.figure(figsize=(12,6))
sns.barplot(x=variability.index, y=variability.values, palette="magma")
plt.xticks(rotation=45)
plt.title("Temperature Variability by Weather Condition")
